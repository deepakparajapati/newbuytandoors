					...
					<div class="col-md-12">
						...
						<div class="filters text-center">
							<ul class="nav nav-pills">
                                ...
                                <li><a href="#" data-filter=".tandoor">Tandoor</a></li>
						...
						<div class="isotope-container row grid-space-20">
							<div class="col-sm-6 col-md-3 isotope-item web-design">
								<div class="image-box">
									...
									<a class="btn btn-default btn-block" data-toggle="modal" data-target="#project-1">${productList[0].productName}</a>
								</div>
								<!-- Modal -->
									...
									<div class="modal-dialog modal-lg">
										<div class="modal-content">
											<div class="modal-header">
												...
												<h4 class="modal-title" id="project-1-label">${productList[0].productName}</h4>
											</div>
												...
												<div class="row">
													...
													<div class="col-md-6">		
															  <div id="myCarousel" class="carousel slide" data-ride="carousel">
															    ...
															    <c:set var="imageString" scope="session" value="${productList[0].productPicUrl}" />
