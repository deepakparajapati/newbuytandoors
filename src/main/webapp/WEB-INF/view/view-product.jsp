...
<body class="no-trans">
	...
	<header class="header fixed clearfix navbar navbar-fixed-top">
		...
		<!-- banner start -->
		<!-- ================ -->
		<div id="banner" class="banner" style="height: 200px; min-height: 0px">
		...
		<!-- ================ -->
						<div class="object-non-visible" data-animation-effect="fadeIn">
							<div class="login-form">
								<h2 class="text-center">Product<span> Update</span></h2>
							</div>
						</div>
		<!-- Modal -->
			...
			<div class="mycheckbox">	
				...
				<div class="form-group">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-secondary" onclick="window.location.href='/product-view';" data-dismiss="modal">Close</button>
