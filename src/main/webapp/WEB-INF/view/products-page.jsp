								...
								<div class="container-fluid">
									...
									<div class="collapse navbar-collapse scrollspy smooth-scroll" id="navbar-collapse-1">
										<ul class="nav navbar-nav navbar-right">
											...
											<li class="active"><a href="./products-tandoors.html">Products</a></li>
...
<div class="container">
	<div class="row">
		<div class="text-center object-non-visible" data-animation-effect="fadeIn" style="width: auto;">
			<h3 class="text-center"><a href="#" style="color: inherit;text-decoration: inherit;" > Complete <span>Range</span></a> |<a href="#" style="color: inherit;text-decoration: inherit;"> Jump to <span>Categories</span> </a></h3>
		</div>
	</div>	

	<div class="row">
		<div class="text-center object-non-visible" data-animation-effect="fadeIn">
			<h2 class="text-center"><b>BuyTandoors</b></h2>
		</div>
	</div>
